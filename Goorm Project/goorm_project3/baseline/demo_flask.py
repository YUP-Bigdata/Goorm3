...
from baseline.lib.tokenization_kobert import KoBertTokenizer

src_tokenizer = KoBertTokenizer.from_pretrained('monologg/kobert')
trg_tokenizer = GPT2Tokenizer.from_pretrained('distilgpt2')

model = EncoderDecoderModel.from_pretrained('/content/drive/MyDrive/goorm_project3/baseline/dump/best_model')
